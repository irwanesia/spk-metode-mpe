    ...
    if (tambah_krt($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'add-kriteria.php';
            </script>
        ";
    }
}
                        ...
                        <div class="card card-social">
                            <div class="card-block border-bottom">
                              ...
                              // ambil data alt dengan kode terbesar
                                $queryKode = mysqli_query($conn, "SELECT max(kode_krt) as kodeTerbesar FROM kriteria");
                                $dataKrt = mysqli_fetch_array($queryKode);
                                $kodeKrt = $dataKrt['kodeTerbesar'];
                                
                                // ambil angka dari kode alt terbesar dengan fungsi substr
                                // dan ubah ke integer dengan int
                                // index nya 1 maka yg diambil dari index ke 2
                                $urutan = (int) substr($kodeKrt, 1, 2);
                                ...
                                $huruf = "C";
                                $kodeKrt = $huruf . sprintf("%02s", $urutan);
                                // var_dump($kodeKrt);
                                // die();
                                 ?>
                                            ...
                                            <div class="form-row">
                                              <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kode" required value="<?= $kodeKrt; ?>" readonly>
                                                </div>
                                                <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" name="bobotkriteria" placeholder="Masukan Bobot Kriteria" required autocomplete="off" autofocus>
                                                </div>
                                            </div>
                                        </div>
